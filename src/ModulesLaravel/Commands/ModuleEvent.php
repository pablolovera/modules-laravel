...
class ModuleEvent extends BaseModules
{
    /**
     ...
     * @var string
     */
    protected $description = 'Create a new Event extending of Core module';
    ...
    public function handle()
    {
        ...
        $this->setToDirectory('Event');

        $this->handleContent();

        $this->fire();

        $this->info('The Module ' . $this->module .' has been received a new event: ' . $this->fileName . '. Be happy!');
    }
